...
Begin VB.UserControl ucGridPlus 
   ...
   Begin RM100.ucScrollbar ucScrollbarH 
      Height          =   225
      Left            =   510
      Top             =   2970
      Width           =   2745
      ...
      EndProperty
   End
   Begin RM100.ucScrollbar ucScrollbarV 
      Height          =   2445
      Left            =   3480
      Top             =   720
      Width           =   225
...
Private Function GetCellAlign(Row As Long, Col As Long) As eGridAlign
    If mRow(Row).Cells(Col).Align <> DefalutCell Then
...
Public Sub AutoHeightRow(ByVal Row As Long)
    ...
    If m_RowsCount = 0 Then Exit Sub
...
Public Sub CellStartEdit(ByVal Row As Long, ByVal Col As Long)
    ...
    If PvGetCellRect(Row, Col, R) Then
        ...
        Dim oText As Object
        Set oText = Text1
        If TypeName(oText) = "ucText" Then ' "UniTextBox" Then
            If (Flags And DT_WORDBREAK) = DT_WORDBREAK Then
                'oText.Multiline = True
                oText.InputType = 5 ' IT_MultiLine
            Else
                'oText.Multiline = False
                oText.InputType = 0 'IT_Text
            End If
        End If
        '------------------------------
        With Text1
...
'    End If
    ...
    With ucScrollbarV
        ...
        .Max = lMax
        If .Max > 0 And RowsInRectArea > 0 Then
...
Private Sub AjustColumnsToClient()
    ...
    If TotalWidth = 0 Then TotalWidth = 1
...
Public Property Get RowsVisiblesCount() As Long
    RowsVisiblesCount = m_RowsCount - mHideRowsCount
End Property

Attribute VB_Name = "ModCutForm"
'********************* RM100 *********************
'   RADIO MAKER WINDOW CUT/TRANSPARENCY MODULE
...
' Boosts the volume on the fft for better visuals
...
Public Function MakeRegion(picSkin As PictureBox) As Long
    ...
    ' user-configurable
    TransparentColor = GetPixel(hDC, 2, 2)
